...
process.on("unhandledRejection", (reason, p) => {
  ...
  process.on("multipleResolves", (type, promise, reason) => {
    console.log("—————————————————————————————————");
    console.logchalk("Anticrash, Multiple Resolves")
    console.log("—————————————————————————————————");
...
//client.on("channelCreate", (message, channel) => {
 //   if(channel.parent.id === "1094695847939285042") {
...
///////////////////////////////////////////////////////////////////////////////
client.login('MTAxOTIxNTM3NDg0MTAzNjgwMQ.Go32is.YnOzEojtBrnq7Oz_0MfQ322nvk6eniB_EOZEs0') 